...
| [`setup-github-issues.sh`](./setup-github-issues.sh) | GitHub Issues for lightweight tracking | All skills |
| [`setup-vercel.sh`](./setup-vercel.sh) | Vercel for event website deployment | Marketing |
