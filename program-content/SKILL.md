...
- When Google Drive is connected, publish the draft agenda as a shared document for committee review and comments
...
- When GitHub Issues is connected, log each submission as an issue with labels for track, format, and review status
...
- When Google Drive is connected, create a shared review matrix spreadsheet where reviewers can add scores and comments
...
- When Google Drive is connected, create a shared folder per speaker for slide uploads and bio/headshot collection
...
- **GitHub Issues** — lightweight tracking for submissions and speaker tasks with labels and milestones
